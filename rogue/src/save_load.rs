...
pub fn save_game(ecs: &mut World) {
    ...
    // Actually serialize
    {
        ...
        serialize_individually!(
            ...
            InflictsFreezingWhenTargeted,
            InflictsBurningWhenTargeted,
            MoveToPositionWhenTargeted,
            BuffsMeleeAttackWhenTargeted,
            BuffsPhysicalDefenseWhenTargeted,
            InflictsBurningWhenEncroachedUpon,
            InflictsFreezingWhenEncroachedUpon,
            SpawnsEntityInAreaWhenTargeted,
